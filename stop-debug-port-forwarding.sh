...
stop_port_forwarding() {
    ...
    local pid_file="/tmp/k8s-debug-$service_name.pid"
...
stop_port_forwarding "service1-user-management-debug"
stop_port_forwarding "service2-data-processing-debug"
stop_port_forwarding "test-dashboard-debug"
